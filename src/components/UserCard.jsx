    ...
    <div className="card bg-white w-96 rounded-2xl shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
      <figure className="relative h-96">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent p-6">
          ...
          <div className="flex gap-2 text-gray-300 text-sm mb-2">
            {age && (
              <span className="badge bg-pink-500 border-none text-white">
                {age} years
              </span>
            )}
            {gender && (
              <span className="badge bg-purple-500 border-none text-white">
                {gender}
              </span>
            )}
          </div>
      ...
      {!editPage && (
        <div className="card-actions justify-center gap-4 p-6">
          <button
            className="btn btn-circle btn-lg bg-white shadow-md hover:bg-red-50 border-none hover:scale-110 transition"
          ...
          <button
            className="btn btn-circle btn-lg bg-gradient-to-r from-pink-500 to-red-500 border-none shadow-lg hover:scale-110 transition"
