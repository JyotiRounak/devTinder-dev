...
const Requests = () => {
  ...
  if (requests.length === 0)
    return (
      <h2 className="text-2xl font-extrabold mb-10 text-gray-800 text-center m-10">
        No Request found
      </h2>
    );
  return (
          ...
          >
            ...
            <div className="card-body items-center text-center">
              ...
              <div className="flex gap-4 mt-4">
                <button
                  className="btn flex-1 bg-red-100 text-red-600 border-none hover:bg-red-200 hover:scale-105 transition"
                  onClick={() =>
                    reviewConnectionRequest("rejected", request._id)
                  }
                >
                  Reject
                </button>
                <button
                  className="btn flex-1 bg-red-100 text-red-600 border-none hover:bg-red-200 hover:scale-105 transition"
                  onClick={() =>
                    reviewConnectionRequest("accepted", request._id)
                  }
                >
                  Accept
                </button>
