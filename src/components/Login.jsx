      ...
      <div className="card w-[380px] bg-white/90 backdrop-blur-md shadow-2xl rounded-2xl">
        <div className="card-body">
            ...
            {!isLogInForm && (
              <>
                <label className="form-control">
                  ...
                  <input
                    type="text"
                    className="input input-bordered w-full bg-white focus:ring-2 focus:ring-pink-400"
                    value={firstName}
          ...
          <div className="card-actions justify-center">
            <button
              className="btn w-full bg-gradient-to-r from-pink-500 to-red-500 text-white border-none hover:scale-[1.02] transition"
          ...
          <div
            className="text-center text-sm text-gray-500 mt-4 cursor-pointer hover:text-pink-500 transition"
